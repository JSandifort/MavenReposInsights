...
public class CoordinateJson {
    ...
    public static class CoordinateDataDeserializer extends JsonDeserializer<Coordinate> {
    ...
    public static class CoordinateDataSerializer extends JsonSerializer<Coordinate> {

        @Override
        public void serialize(Coordinate value, JsonGenerator gen, SerializerProvider provider) throws IOException {
            gen.writeString(value.groupId + ":" + value.artifactId + ":" + value.version);
        }
    }
}